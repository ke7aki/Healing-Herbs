...
public class HerbalPlantOptionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void prepareData() {
        ...
        herbalPlantsRow.setUses(">> There is some preliminary evidence to suggest that oral administration of aloe vera might be effective in reducing blood glucose in diabetic patients and in lowering blood lipid levels in hyperlipidemia.\n\n" +
        ...
        herbalPlantsRow.setScientificName("");
        herbalPlantsRow.setDetails("Thankuni  grows in tropical swampy areas.The stems are slender, creeping stolons, green to reddish-green in color, connecting plants to each other. It has long-stalked, green, reniform leaves with rounded apices which have smooth texture with palmately netted veins. The leaves are borne on pericladial petioles, around 2 cm.");
